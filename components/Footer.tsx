  ...
  return (
    <footer className="border-t border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-900">
      <div className="mx-auto max-w-6xl px-6 py-12">
        ...
        <div className="flex flex-col items-center gap-2 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between dark:text-slate-400">
          <span className="inline-flex items-center gap-1">
            <FaRegCopyright size={16} /> {new Date().getFullYear()} Circulet.
            All rights reserved.
          </span>
